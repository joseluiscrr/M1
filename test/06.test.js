const { BinarySearchTree } = require('../homework/06-estructura-de-datos-03')
...
describe('binarySearchTree', function () {
  ...
  it('ordena valores cuando agrega', function () {
    ...
    tree.insert(12);
    tree.insert(11);
    expect(tree.root.left.left.right.left.left.left.value).toBe(11);
    tree.insert(30);
    tree.insert(35);
    tree.insert(33);
    tree.insert(31);
    tree.insert(34);
    expect(tree.root.right.right.right.left.left.right.left.right.value).toBe(34);
  });
  ...
  it('corre depth-first (en recorrido "pre-order") cuando depthFirstForEach() es ejecutado con la opcion "pre-order"', function () {
    ...
    testArr = tree.depthFirstForEach('pre-order');
  ...
  it('corre depth-first (en recorrido "post-order" cuando depthFirstForEach() es ejecutado con la opcion "post-order"', function () {
    ...
    testArr = tree.depthFirstForEach('post-order');
  ...
  it('corre breadth-first cuando breadthFirstForEach() es ejecutado', function () {
    ...
    const depth = tree.breadthFirstForEach();
